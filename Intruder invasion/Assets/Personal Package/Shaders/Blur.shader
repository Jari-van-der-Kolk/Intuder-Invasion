...
//
//    half4 sum = half4(0, 0, 0, 0);
//#define BLURPIXEL(weight,kernelx) tex2Dproj(_GrabTexture,UNITY_PROJ_COORD(float4(i.ivgrab.x, i.uvgrab.y + _GrabTexture_TexelSize.y * kernely * _Size, i.uvgrab.z, i.uvgrab.w))) * weight
//    sum += BLURPIXEL(0.05, -4.0);
//    sum += BLURPIXEL(0.09, -3.0);
//    sum += BLURPIXEL(0.12, -2.0);
//    sum += BLURPIXEL(0.15, -1.0);
...
//    {
//        half4 color = (tex2D(_MainTex, IN.texcoord) + TextureSampleAdd) * IN.color;
